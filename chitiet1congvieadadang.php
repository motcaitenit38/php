...
<header>
        <div class="container-fluid">
            <div class="row header1">
                ...
                <div class="col-md-3">
                    <div class="btn-group lienket" role="group"><a class="btn btn-link" role="button" href="#">Hồ sơ doanh nghiệp</a><a class="btn btn-info" role="button" href="#">Nhà tuyển dụng</a></div>
                </div>
            </div>
        </div>
    </header>
